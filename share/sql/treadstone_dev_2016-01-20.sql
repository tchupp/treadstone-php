...
# Database: treadstone_dev
# Generation Time: 2016-01-20 17:11:05 +0000
# ************************************************************
...
INSERT INTO `treadstone_user` (`id`, `login`, `password_hash`, `first_name`, `last_name`, `email`, `activated`, `activation_key`, `reset_key`, `created_date`, `reset_date`, `last_modified_by`, `last_modified_date`)
VALUES
	(1,'system','$2a$10$mE.qmcV0mFU5NcKh73TZx.z4ueI/.bDWbj0T1BYyqP481kGGarKLG','System','System','system@localhost',0,NULL,NULL,'2016-01-18 17:48:55',NULL,NULL,NULL),
	(2,'chuppthe','$2a$10$c110a6fb7f49b251605b3u0Q5o3v8YRMCvJIMJMsqhCCKsNmNP6fS','Theo','Chupp','chuppthe@msu.edu',1,NULL,NULL,'2016-01-18 20:10:10',NULL,NULL,NULL);
